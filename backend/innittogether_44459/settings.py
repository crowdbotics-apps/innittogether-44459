"""
Django settings for innittogether_44459 project.
...
ROOT_URLCONF = 'innittogether_44459.urls'
...
WSGI_APPLICATION = 'innittogether_44459.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "innittogether_44459 API",
    "DESCRIPTION": "API documentation for innittogether_44459 App",
    "VERSION": "v1",
}
